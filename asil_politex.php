<?php include("header.php"); ?>
		...
		<div class="row component component-fullwidth-child" id="component">
			<img src="img/slide_asilpolitex.jpg">
		</div>
		<article class="row">
			<div class="container">
				<div class="breadcrumbs col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><a href="">главная</a> / <a href="">направления</a> /</div>
				<h2 class="col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><span>AsilPolitex</span></h2>
				<div class="col-lg-2 col-xs-3 col-sm-3 col-md-2">
					<ul class="child-u">
						<li><a href="" class="active">AsilPolitex</a></li>
						<li><a href="">AsilPolimerstone</a></li>
						<li><a href="">AsilStone</a></li>
						<li><a href="">AsilPorolon</a></li>
						<li><a href="">AsilOil</a></li>
		...
		<footer class="row">
			<div class="container">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 active">
					<ul>
						<h5><a href="#" class="active">направления</a></h5>
