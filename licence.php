<?php include("header.php"); ?>
		...
		<article class="row">
			<div class="container">
				...
				<h2 class="col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><span>Лицензии</span></h2>
				<div class="col-lg-2 col-xs-3 col-sm-3 col-md-2">
					<ul class="child">
						<li><a href="">отзывы клиентов</a></li>
						<li><a href="" class="active">лицензии</a></li>
				...
				<div class="col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2" id="licence-wrap" style="margin-top:50px;">
				<div class="picture-wrap"><div style="margin-top:40%;text-align:center;"><span>Лицензия<br> №236842</span></div><div style="margin-top:18%; text-align:center;">«На оказание<br> услуг...»</div></div>
				<div class="picture-wrap"><div style="margin-top:40%;text-align:center;"><span>Лицензия<br> №236842</span></div><div style="margin-top:18%; text-align:center;">«На оказание<br> услуг...»</div></div>
				<div class="picture-wrap"><div style="margin-top:40%;text-align:center;"><span>Лицензия<br> №236842</span></div><div style="margin-top:18%; text-align:center;">«На оказание<br> услуг...»</div></div>
				<div class="picture-wrap"><div style="margin-top:40%;text-align:center;"><span>Лицензия<br> №236842</span></div><div style="margin-top:18%; text-align:center;">«На оказание<br> услуг...»</div></div>
				<div class="picture-wrap"><div style="margin-top:40%;text-align:center;"><span>Лицензия<br> №236842</span></div><div style="margin-top:18%; text-align:center;">«На оказание<br> услуг...»</div></div>
