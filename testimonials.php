<?php include("header.php"); ?>
		...
		<article class="row">
			<div class="container">
				...
				<h2 class="col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><span>Отзывы клиентов</span></h2>
				<div class="col-lg-2 col-xs-3 col-sm-3 col-md-2">
					<ul class="child">
						<li><a href="" class="active">отзывы клиентов</a></li>
				...
				<div class="col-lg-10 col-xs-8 col-xs-offset-1 col-sm-offset-0 col-sm-9 col-md-10">
					...
					<div class="testimonial col-lg-4 col-xs-4 col-sm-4 col-md-4">
						<div class="testimonial_quote">Aliquam eleifend accumsan malesuada. Pellentesque ut urna ut leo posuere aliquet. Cras elementum, ipsum at tempus ultricies, mauris nibh eleifend risus, ut dictum sapien libero in urna. Aliquam sed eros ac lacus placerat tristique. Donec ac lacinia turpis, a facilisis felis. Nullam id magna commodo, blandit justo quis, elementum metus.</div>
						<div class="testimonial_author">
							<b>Сохибов Ф.</b><br>
							<span>исполнительный директор SomonAir</span>
						</div>
					</div>
					<div class="testimonial col-lg-4 col-xs-4 col-sm-4 col-md-4">
						<div class="testimonial_quote">Aliquam eleifend accumsan malesuada. Pellentesque ut urna ut leo posuere aliquet. Cras elementum, ipsum at tempus ultricies, mauris nibh eleifend risus, ut dictum sapien libero in urna. Aliquam sed eros ac lacus placerat tristique. Donec ac lacinia turpis, a facilisis felis. Nullam id magna commodo, blandit justo quis, elementum metus.</div>
