<?php include("header.php"); ?>
			...
			<div class="container">
				<div class="row">
					<ul class="list-inline">
						...
						<li class="col-lg-3 col-xs-6 col-sm-3 col-lg-offset-1"><a href="directions.php" class="active">направления</a></li>
		...
		<div class="row component component-fullwidth-child" id="component">
			<img src="img/slide-directions.jpg">
		</div>
		<article class="row">
			<div class="container">
				<div class="breadcrumbs col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><a href="">главная</a> /</div>
				<h2 class="col-lg-10 col-xs-12 col-sm-10 col-lg-offset-2 col-xs-offset-0 col-sm-offset-2"><span>Направления</span></h2>
				<div class="col-lg-2 col-xs-3 col-sm-3 col-md-2">
					<ul class="child-u">
						<li><a href="">AsilPolitex</a></li>
